        ...
        private void Start() {
            ...
            switch (wallPainting) {
                case mode.On:
                    ...
                    break;
                case mode.Radomly:
                    Material[] mts = Resources.LoadAll("Materials/Dataset/Walls", typeof(Material)).Cast<Material>().ToArray();
            ...
            switch (floorPainting) {
                case mode.On:
                    ...
                    break;
                case mode.Radomly:
                    Material[] mts = Resources.LoadAll("Materials/Dataset/Floors", typeof(Material)).Cast<Material>().ToArray();
