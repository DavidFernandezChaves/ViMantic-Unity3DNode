...
public class SemanticRoom : MonoBehaviour
{
    ...
    public Dictionary<string, float> _categories;



    public void InitializeCategories(List<string> categories) {
        _categories = new Dictionary<string, float>();
         var initialProbability = 1 / categories.Count;
        foreach (string c in categories) {
            _categories.Add(c, initialProbability);
        }
    }
